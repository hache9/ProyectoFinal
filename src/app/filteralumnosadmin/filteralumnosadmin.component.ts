...
@Component({
  selector: 'app-filteralumnosadmin',
  templateUrl: './filteralumnosadmin.component.html',
  styleUrls: ['./filteralumnosadmin.component.scss'],
})
export class FilteralumnosadminComponent implements OnInit {
  alumnos: any;
  alumnoFiltered: any;
